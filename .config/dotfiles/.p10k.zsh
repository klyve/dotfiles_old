# Generated by Powerlevel10k configuration wizard on 2020-10-05 at 21:27 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # wifi                  # wifi speed
    telepresence               # example user-defined segment (see prompt_example function below)
    moenv
  ...
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    '~/work(|/*)'  WORK     ''
    '~/.go/src/github.com/MaritimeOptima(|/*)'  WORK     ''
    '~(|/*)'       HOME     ''
    '*'            DEFAULT  '')
  #
  ...
  function prompt_telepresence() {
    if [[ $(ps -f | grep "telepresence" | grep -v "grep"|wc -l) -ge 1 ]]; then
        if [ -z "$TELEPRESENCE_ROOT" ]; then
          p10k segment -f 208 -t 'Telepresence'
        else
          p10k segment -f 208 -i '⭐' -t 'Telepresence'
        fi
    else
    fi
  }

  function prompt_moenv() {
      if [[ ! -z "$MO_ENVIRONMENT" ]]; then
        p10k segment -f 196 -t "$MO_ENVIRONMENT"
    fi
  }
